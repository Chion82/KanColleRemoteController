...
namespace Grabacr07.KanColleWrapper.Models
{
	...
	public class RepairingDock : TimerNotifier, IIdentifiable
	{
        ...
        /// <summary>
        /// Export Reparing dock data to JSON file
        /// Added by @Chion82
        /// </summary>
        public void ExportToFile()
        {
            ...
            if (this.Ship!=null && this.Remaining!=null)
            {
                jsonObj = new
                {
                    ...
                    shipId = this.ShipId,
                    ship = FleetInfoUtils.GetShipInfo(this.Ship)
                };
            }
            else
            {
            ...
            if (this.Id<=10)
            {
                repairingDocks[this.Id-1] = jsonObj;
            }
            String jsonStr = DynamicJson.Serialize(repairingDocks);
            DataExportUtils.WriteStringToFile("repairingdocks.json", jsonStr);
        }

        static public Object[] repairingDocks = new Object[10];
	}
}
